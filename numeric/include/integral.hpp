...
public:
    ...
    explicit Trapezoidal(const Expression& expr);
...
public:
    ...
    //! @param expr - target expression
    explicit Simpson(const Expression& expr);
...
public:
    ...
    //! @param expr - target expression
    explicit Romberg(const Expression& expr);
...
public:
    ...
    //! @param expr - target expression
    explicit Gauss(const Expression& expr);
...
public:
    ...
    //! @param expr - target expression
    explicit MonteCarlo(const Expression& expr);
