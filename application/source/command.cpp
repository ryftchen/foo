...
#define COMMAND_PRINT_TASK_BEGIN_TITLE(taskCategory, taskType)                                                       \
    std::cout << "\r\n"                                                                                              \
    ...
    {
#define COMMAND_PRINT_TASK_END_TITLE(taskCategory, taskType)                                                       \
    }                                                                                                              \
    std::cout << "\r\n"                                                                                            \
              << taskCategory << " TASK: " << std::setiosflags(std::ios_base::left) << std::setfill('.')           \
...
void Command::runMatch() const
{
    ...
    COMMAND_PRINT_TASK_BEGIN_TITLE(GeneralTaskCategory::algorithm, AlgorithmTaskType::match);
    ...
    COMMAND_PRINT_TASK_END_TITLE(GeneralTaskCategory::algorithm, AlgorithmTaskType::match);
}
...
void Command::runNotation() const
{
    ...
    COMMAND_PRINT_TASK_BEGIN_TITLE(GeneralTaskCategory::algorithm, AlgorithmTaskType::notation);
    ...
    COMMAND_PRINT_TASK_END_TITLE(GeneralTaskCategory::algorithm, AlgorithmTaskType::notation);
}
...
void Command::runSearch() const
{
    ...
    COMMAND_PRINT_TASK_BEGIN_TITLE(GeneralTaskCategory::algorithm, AlgorithmTaskType::search);
    ...
    COMMAND_PRINT_TASK_END_TITLE(GeneralTaskCategory::algorithm, AlgorithmTaskType::search);
}
...
void Command::runSort() const
{
    ...
    COMMAND_PRINT_TASK_BEGIN_TITLE(GeneralTaskCategory::algorithm, AlgorithmTaskType::sort);
    ...
    COMMAND_PRINT_TASK_END_TITLE(GeneralTaskCategory::algorithm, AlgorithmTaskType::sort);
}
...
void Command::runArithmetic() const
{
    ...
    COMMAND_PRINT_TASK_BEGIN_TITLE(GeneralTaskCategory::numeric, NumericTaskType::arithmetic);
    ...
    COMMAND_PRINT_TASK_END_TITLE(GeneralTaskCategory::numeric, NumericTaskType::arithmetic);
}
...
void Command::runDivisor() const
{
    ...
    COMMAND_PRINT_TASK_BEGIN_TITLE(GeneralTaskCategory::numeric, NumericTaskType::divisor);
    ...
    COMMAND_PRINT_TASK_END_TITLE(GeneralTaskCategory::numeric, NumericTaskType::divisor);
}
...
void Command::runIntegral() const
{
    ...
    COMMAND_PRINT_TASK_BEGIN_TITLE(GeneralTaskCategory::numeric, NumericTaskType::integral);
    ...
    COMMAND_PRINT_TASK_END_TITLE(GeneralTaskCategory::numeric, NumericTaskType::integral);
}
...
void Command::runOptimal() const
{
    ...
    COMMAND_PRINT_TASK_BEGIN_TITLE(GeneralTaskCategory::numeric, NumericTaskType::optimal);
    ...
    COMMAND_PRINT_TASK_END_TITLE(GeneralTaskCategory::numeric, NumericTaskType::optimal);
}
...
void Command::runSieve() const
{
    ...
    COMMAND_PRINT_TASK_BEGIN_TITLE(GeneralTaskCategory::numeric, NumericTaskType::sieve);
    ...
    for (int i = 0; i < Bottom<SieveMethod>::value; ++i)
    {
        ...
        const auto taskCategoryMap = std::next(
            std::next(generalTaskMap.cbegin(), GeneralTaskCategory::numeric)->second.cbegin(), NumericTaskType::sieve);
        const auto targetMethod = get<TaskMethodVector>(taskCategoryMap->second).at(i);
        const std::string threadName = std::string{1, taskCategoryMap->first.at(0)} + "_" + targetMethod;
        using util_hash::operator""_bkdrHash;
        switch (util_hash::bkdrHash(targetMethod.data()))
    ...
    COMMAND_PRINT_TASK_END_TITLE(GeneralTaskCategory::numeric, NumericTaskType::sieve);
}
...
std::ostream& operator<<(std::ostream& os, const Command::GeneralTaskCategory& taskCategory)
{
    switch (taskCategory)
    {
        case Command::GeneralTaskCategory::algorithm:
            os << "ALGORITHM";
            break;
        case Command::GeneralTaskCategory::numeric:
            os << "NUMERIC";
            break;
        default:
            os << "UNKNOWN: " << static_cast<std::underlying_type_t<Command::GeneralTaskCategory>>(taskCategory);
    }
