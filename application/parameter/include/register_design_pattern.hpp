...
//! @brief Reflect the design pattern category name and alias name to the field in the command line argument mapping.
...
//! @brief Reflect the design pattern category entry and choice name to the field in the command line argument mapping.
