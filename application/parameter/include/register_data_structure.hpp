...
//! @brief Reflect the data structure category name and alias name to the field in the command line argument mapping.
...
//! @brief Reflect the data structure category entry and choice name to the field in the command line argument mapping.
