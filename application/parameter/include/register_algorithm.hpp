...
//! @brief Reflect the algorithm category name and alias name to the field in the command line argument mapping.
...
//! @brief Reflect the algorithm category entry and choice name to the field in the command line argument mapping.
