...
public:
    ...
    void setRandomArray(T array[], const uint32_t len, const T left, const T right) const;
    template<typename U>
...
protected:
    char *formatArray(const T *const array, const uint32_t len, char *const buffer,
