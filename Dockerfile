...
&& cd /root \
&& sudo curl -L https://github.com/mvdan/sh/releases/download/v3.4.2/shfmt_v3.4.2_linux_amd64 >/usr/local/bin/shfmt \
...
&& cmake -S ./codebrowser -B ./codebrowser -DCMAKE_CXX_COMPILER=clang++-12 -DCMAKE_BUILD_TYPE=Release \
